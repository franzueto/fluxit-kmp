...
**Last updated:** 2026-05-28 (Phase 03 mid-flight; §5/§6/§7/§8 complete + §10 commonTest foundation + integration + concurrency + mapper + per-query gap + error-path tests; remaining §10 sub-bullet d (migration harness) + §13 hand-off ahead)
